...
import com.noordwind.apps.collectively.presentation.settings.dagger.UserRemarksScreenModule
...
class UserRemarksActivity : com.noordwind.apps.collectively.presentation.BaseActivity(), UserRemarksMvp.View, MainScreenRemarksListAdapter.OnRemarkSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        TheApp[this].appComponent!!.plusUserRemarksScreenComponent(UserRemarksScreenModule(this)).inject(this)
